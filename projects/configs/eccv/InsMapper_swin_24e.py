...
use_anchor_fuse=True
# ======================
query_generation='hybrid_pts'
query_fusion='self_attn'
masked_ratio=0.25
# ======================

load_from='ckpts/swin_tiny_patch4_window7_224.pth'
model = dict(
    type='MapTR',
    use_grid_mask=True,
    video_test_mode=False,
    # pretrained=dict(img='ckpts/swin_small_patch4_window7_224.pth'),
    use_topo=use_topo,
    # swin tiny
    img_backbone=dict(
    ...
    pts_bbox_head=dict(
        ...
        dir_interval=1,
        query_embed_type=query_generation,
        ...
        use_topo=use_topo,
        use_anchor_fuse=use_anchor_fuse,
...
dataset_type = 'CustomNuScenesTIDataset'
# data_root = './data/'
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='NewTensorboardLoggerHook')
    ])
