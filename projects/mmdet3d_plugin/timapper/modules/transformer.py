...
class MapTRPerceptionTransformer(BaseModule):
    ...
    def forward(self,
        ...
        # vis reference points
        # vis_anchor(reference_points)


        num_vec = query.shape[1]//self.num_pts_per_vec
        query_pos = query_pos.permute(1, 0, 2)

        query = query.permute(1, 0, 2)
        bev_embed = bev_embed.permute(1, 0, 2)

        tensor_shape = (bs, num_vec, self.num_pts_per_vec)
